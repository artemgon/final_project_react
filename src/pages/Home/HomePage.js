    ...
    <div className="home-page">
      <div className="content">
        ...
        <section className="main-image">
          <img src="/images/Home/Hotel Parismo.png" alt="Hotel Parismo Exterior" />
        </section>
        ...
        <section className="room-section">
          <div className="room-image-container">
            <img src="/images/Home/Room 1.png" alt="Luxury Room" />
            <div className="room-overlay">
              <span className="room-title">Rooms & Suites</span>
            </div>
          </div>
          <button className="reserve-button" onClick={handleBookClick}>Book Now</button>
        </section>

        <hr className="divider" />

        <h3 className="section-title">The New Parismo Bar</h3>
        <p className="fixed-width-text">
        ...
        <section className="image-section bar-img">
          <img src="/images/Home/Bar.png" alt="Parismo Bar" />
        </section>
        ...
        <section className="image-section shop-img">
          <img src="/images/Home/Shop.png" alt="Pastry Creations" />
        </section>
      </div>
        ...
        <div className="footer-top">
          ...
          <div className="footer-links">
            <div className="follow-section">
              <span className="follow-text follow-item">Follow Parismo </span>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="follow-icon follow-item">
                <FacebookOutlined />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="follow-icon follow-item">
                <InstagramOutlined />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="follow-icon follow-item">
                <TwitterOutlined />
              </a>
            </div>
            <div className="follow-section">
              <span className="follow-text follow-item"> Subscribe to Newsletter</span>
              <div className="newsletter">
                <form onSubmit={handleSubscribe}>
                  ...
                  />
                  <button 
                    className="newsletter-button follow-item" 
                    type="submit"
                    disabled={isLoading}
                  >
                    {isLoading ? '...' : 'OK'}
